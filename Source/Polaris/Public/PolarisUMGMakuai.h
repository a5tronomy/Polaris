...
public:
    ...
    void ShowGhostUpdateCount(int32 side);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void RequestShowBatchReplayIndicator(int32 IndexNow, int32 IndexMax);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void OnSetPlayerInformation(int32 side, const UTexture2D* texture_panel, const FString& Name, const UTexture2D* texture_rank, int32 power, int32 platform_tag, const FString& Area, const TArray<FTopStats>& top_stats, int32 ghost_update_count);
