...
#include "PolarisUMGPlayDataCharaWinRateTargetStruct.h"
...
public:
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void PlayCharaWinRateIOAnimation(bool in_anim, bool quick);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void OnSelectCharaWinRateItem(int32 Index, bool Force);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void OnCreatePlayRecordWinDetailed(const FString& total_header_text, const TArray<FPolarisUMGPlayDataTblItemStruct>& total_items, const FString& battle_header_text, const TArray<FPolarisUMGPlayDataTblItemStruct>& battle_items);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void OnCreateCharaWinRate(const FPolarisUMGPlayDataCharaWinRateTargetStruct& head_info, const TArray<FPolarisUMGPlayDataCharaWinRateItemStruct>& items);
    
    UFUNCTION(BlueprintImplementableEvent)
    void OnCreateCharaRankWin2(const TArray<FPolarisUMGPlayDataCharaItemStruct>& items, EPolarisUMGPlayDataSortType sort_type, int32 Type, const FString& period_text);
    ...
    FString GetRankedMatchText();
    
    UFUNCTION(BlueprintPure)
    FString GetOnlineSeasonText();
