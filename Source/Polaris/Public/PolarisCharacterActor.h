...
public:
    ...
    UPROPERTY(BlueprintReadWrite)
    bool IsCopyMaterialBottom;
    
    UPROPERTY(BlueprintReadWrite)
    bool IsCopyMaterialUpper;
    
    UPROPERTY(BlueprintReadWrite)
    int32 AltSkinColorSlotNum;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere)
    TArray<FCharacterMIDParameter> CharacterMIDParameters;
...
public:
    ...
    void UpdateCharacterMaterialAnimation(int32 Type, bool OneShotAnimEnable, float OneShotAnimFrame, bool LoopAnimEnable, float LoopAnimFrame);
    ...
    UFUNCTION(BlueprintPure)
    bool IsEquipHoodRemoveItemOtherThanHef();
    
    UFUNCTION(BlueprintPure)
    bool IsEquipHoodRemoveItem();
    
    UFUNCTION(BlueprintPure)
    bool IsAccItemPos(int32 _Pos) const;
    ...
    UFUNCTION(BlueprintImplementableEvent)
    TArray<UMaterialInstanceDynamic*> GetSkinMIDs() const;
...
public:
    UFUNCTION(BlueprintImplementableEvent)
    TArray<UMaterialInstanceDynamic*> GetEyeMIDs() const;
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void CreateBakeSuntanSingle(UMeshComponent* SourceMeshComp, UMaterialInterface* SourceMeshMaterial, int32 ItemPos, int32 AccNum, bool NewIsSuntan, bool IsUseSourceMeshMaterialDirect);
    ...
    UFUNCTION(BlueprintCallable)
    void CancelCharacterMaterialAnimation(int32 Type, bool isEnable);
