...
public:
    ...
    DECLARE_DYNAMIC_DELEGATE_OneParam(FCrossPrivilegeCallback, EPolarisParentalControlStatus, Result);
    ...
    UFUNCTION(BlueprintCallable)
    static void SetEnableLobbyHudSwitch(bool is_enable);
    
    UFUNCTION(BlueprintCallable)
    static void RequestCrossPrivilege(const FString& xuid, ULobbyBlueprintFunctionLibrary::FCrossPrivilegeCallback Callback);
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyShouldReplayShowTips();
    ...
    UFUNCTION(BlueprintCallable)
    static void LobbySendKpiCommentBoardViewList(int32 player_list_uu, int32 board_setting_uu);
    
    UFUNCTION(BlueprintCallable)
    static void LobbySendKpiCommentBoardView(int64 TargetCosmosId, const FString& referenceType, const FString& approachContentsType, const FString& approachContentsDetail);
    
    UFUNCTION(BlueprintCallable)
    static void LobbySendKpiCommentBoardSet(int64 TargetCosmosId, const FString& actionType, const FString& Source, const FString& content_type, const FString& content_detail);
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyIsWatching();
    
    UFUNCTION(BlueprintPure)
    static bool LobbyIsUgcRestricted();
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyIsReplayRenovated();
    
    UFUNCTION(BlueprintPure)
    static bool LobbyIsRandomSideSelect();
    
    UFUNCTION(BlueprintCallable)
    static bool LobbyIsPlayerMatchModeInWatchingBattleScene();
    
    UFUNCTION(BlueprintPure)
    static bool LobbyIsPlayerCustomizeSlotEnable();
    
    UFUNCTION(BlueprintPure)
    static bool LobbyIsPlayerBlocked(const FString& polarisId, const FString& platformId);
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyIsEnablePlayerCustomizeSlot();
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyIsEnableGhostVsGhostOrder();
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyIsEnableCommentBoard();
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyGetGameSettingCrossPlayFlag_Profile();
    ...
    UFUNCTION(BlueprintCallable)
    static void LobbyFastTravelSendKpiWarpToPlayer(int64 TargetCosmosId, const FString& targetLobbyId, const FString& fastTravelType);
    
    UFUNCTION(BlueprintCallable)
    static void LobbyFastTravelSendKpiAreaWarp(uint8 areaIndex);
    ...
    UFUNCTION(BlueprintCallable)
    static void LobbyChangeAutoInputForAgingWarp();
    ...
    UFUNCTION(BlueprintCallable)
    static void LobbyButtonHelpPlayingSequencer();
    ...
    UFUNCTION(BlueprintPure)
    static bool HasJoinedLounge(const FString& loungeEId);
    
    UFUNCTION(BlueprintPure)
    static bool GetMyCrossPrivilege(bool InFriendOnly, bool InAll);
    
    UFUNCTION(BlueprintPure)
    static bool GetLobbyHudVisibility();
    
    UFUNCTION(BlueprintPure)
    static bool EnableLoungeAreaFeature();
    
    UFUNCTION(BlueprintPure)
    static bool EnableAnywhereMatchingFeature();
