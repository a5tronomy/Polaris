...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetRandomPlayerSide(bool isRandom);
    ...
    UFUNCTION(BlueprintCallable)
    void OpenQuickPlayerCustomizeSelect();
    ...
    bool IsRandomPlayerSide() const;
    
    UFUNCTION(BlueprintPure)
    bool IsPlayerSideLeft() const;
    
    UFUNCTION(BlueprintPure)
    bool IsOpenPlayerCustomizeSelect() const;
    ...
    UFUNCTION(BlueprintPure)
    FString GetSelectedPlayerCustomizeSlotName() const;
    ...
    UFUNCTION(BlueprintPure)
    TArray<FString> GetRankRangeText();
    
    UFUNCTION(BlueprintPure)
    int32 GetRankRangeDefaultIndex() const;
    
    UFUNCTION(BlueprintPure)
    int32 GetRankRange() const;
    
    UFUNCTION(BlueprintPure)
    int32 GetQuickMatchRankRangeDefaultIndex() const;
    ...
    UFUNCTION(BlueprintPure)
    TArray<FString> GetInformationBarText();
