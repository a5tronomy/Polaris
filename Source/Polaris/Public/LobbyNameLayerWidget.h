...
public:
    ...
    void ImplToggleVisibleCommentBoard(AActor* Actor);
    
    UFUNCTION(BlueprintCallable, BlueprintImplementableEvent)
    void ImplSetVisibleCommentBoard(AActor* Actor, bool IsVisible);
    
    UFUNCTION(BlueprintCallable, BlueprintImplementableEvent)
    void ImplSetEnableTargetArrow(AActor* Actor, bool Enable);
    
    UFUNCTION(BlueprintCallable, BlueprintImplementableEvent)
    void ImplSetCommentBoard(AActor* Actor, const FString& UserId, const FString& Message, int32 templateId, int32 templateSubId, const FName& stampName);
