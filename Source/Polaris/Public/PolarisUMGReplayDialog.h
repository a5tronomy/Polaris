...
public:
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void SetReplayTipsInfo(int32 side, int32 punish_tips, int32 combo_tips, int32 crouch_tips, int32 throw_escape_tips);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void SetReplayConsecWinsInfo(int32 side, int32 wins);
