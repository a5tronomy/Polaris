...
public:
    ...
    void OnUpdateTabButton(int32 ID, bool is_event_icon);
    
    UFUNCTION(BlueprintImplementableEvent)
    void OnUpdateMenuItem(int32 item_id, bool is_favorite, bool is_new_icon, bool is_event_icon, int32 ignore_menu_id);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void OnCreateTabButton(int32 ID, const FString& Name, bool is_event_icon);
...
public:
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void OnAddFavoriteMenuItem(int32 menu_id, int32 item_id, const FString& text_id, bool is_selectable, bool is_new_icon, bool is_event_icon);
