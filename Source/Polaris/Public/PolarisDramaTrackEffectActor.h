...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void RequestCharacterEffectNoEffectManager(FRequestCharacterEffectNotMotHead Request);
    
    UFUNCTION(BlueprintCallable)
    void RequestAttachOffsetEffect(UNiagaraSystem* niagara_asset, EDramaTrackBoneIdNotMotHead bone_id, FVector offset_location, FRotator offset_rotation, int32 player_index, int32 effect_id);
    
    UFUNCTION(BlueprintCallable)
    void RequestAddAuraNoEffectManager();
