...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void AutoTest_SetFinishCharCusItemThumbnailCapture();
    ...
    UFUNCTION(BlueprintCallable)
    static bool AutoTest_IsFinishCharCusItemThumbnailCapture();
    ...
    UFUNCTION(BlueprintCallable)
    static EAutoTest AutoTest_GetTestType();
