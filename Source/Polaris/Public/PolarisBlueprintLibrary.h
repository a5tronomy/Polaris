...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static FSoundPlayerVoiceHandle KeyOnWWiseAudioEvent2(UAkAudioEvent* _srcEvent, int32 NoMultiPlayFrame, AActor* _srcActor);
    
    UFUNCTION(BlueprintCallable)
    static void KeyOnWWiseAudioEvent(UAkAudioEvent* _srcEvent, int32 NoMultiPlayFrame, AActor* _srcActor);
    
    UFUNCTION(BlueprintCallable)
    static void KeyOffWWiseAudioEvent(FSoundPlayerVoiceHandle Handle, int32 duration_millisecond);
    
    UFUNCTION(BlueprintPure)
    static bool IsZoneDrive();
    
    UFUNCTION(BlueprintPure)
    static bool IsWeakening(int32 player_id);
    ...
    UFUNCTION(BlueprintCallable)
    static bool IsValidSoundPlayerVoiceHandle(FSoundPlayerVoiceHandle Handle);
    
    UFUNCTION(BlueprintPure)
    static bool IsSwitchedToPracticeDeku();
    ...
    UFUNCTION(BlueprintCallable)
    static bool IsPlayingWWiseAudioEvent(FSoundPlayerVoiceHandle Handle);
    ...
    UFUNCTION(BlueprintPure)
    static int32 GetTextureFormat(UTexture2D* pTex);
    ...
    UFUNCTION(BlueprintPure)
    static TSubclassOf<AActor> GetResultLightBP();
    
    UFUNCTION(BlueprintPure)
    static EPolarisResolutionUpscaling GetResolutionUpscaling();
    
    UFUNCTION(BlueprintCallable)
    static void GetReplayTipsForBattleResult(int32& Punishes, int32& Combos, int32& Crouches, int32& Escapes);
    ...
    UFUNCTION(BlueprintPure)
    static int32 GetFighterBodySizeType(int32 player_id);
