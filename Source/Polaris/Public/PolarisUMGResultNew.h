...
public:
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void SetIsGhost(bool is_owner, bool is_ghost);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void OnSetRewardForRankMatch(const TArray<FPolarisUMGResultNewRewardStruct>& items);
    ...
    UFUNCTION(BlueprintImplementableEvent)
    void CheckRematchHistoryNum(int32 OWN, int32 opp, bool display_round_plate);
