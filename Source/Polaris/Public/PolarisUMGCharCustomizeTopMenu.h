...
#include "PolarisUMGCharCustomizeTopMenu.generated.h"

class UTexture2D;

UCLASS(EditInlineNew)
class POLARIS_API UPolarisUMGCharCustomizeTopMenu : public UPolarisUserWidget {
    GENERATED_BODY()
public:
    UPolarisUMGCharCustomizeTopMenu();
