...
public:
    ...
    static void LobbyReport(int32 targetType, int32 violationType, const FString& comment, const FLobbyReportEvidence& evidence, ULobbyReport::FOnReport OnReport, bool bUseCommentOnly);
