...
void ULobbyChatWidget::SetIsActiveCommentBoard(bool NewIsActive) {
}
...
void ULobbyChatWidget::OpenProfile_Implementation(const FString& in_cosmos_id, int32 in_submenu_type) {
}
