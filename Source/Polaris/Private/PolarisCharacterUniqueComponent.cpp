...
void UPolarisCharacterUniqueComponent::UpdateMaterialParameters_Implementation(float DeltaTime) {
}
...
void UPolarisCharacterUniqueComponent::SetBodyTransform(EPolarisBodyTransformState State, bool isForce, bool IsAlways) {
}
