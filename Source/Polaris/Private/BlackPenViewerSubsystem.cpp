...
UBlackPenViewerSubsystem::UBlackPenViewerSubsystem() {
    ...
    this->m_sequence_viewer_controller = NULL;
}

void UBlackPenViewerSubsystem::SetSequenceViewerController(ABlackPenSequenceViewerController* Controller) {
}
...
ABlackPenSequenceViewerController* UBlackPenViewerSubsystem::GetSequenceViewerController() const {
    return NULL;
}
