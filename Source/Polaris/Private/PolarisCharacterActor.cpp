...
APolarisCharacterActor::APolarisCharacterActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->IsCopyMaterialBottom = false;
    this->IsCopyMaterialUpper = false;
    this->AltSkinColorSlotNum = 5;
...
bool APolarisCharacterActor::IsEquipHoodRemoveItemOtherThanHef() {
    return false;
}
...
bool APolarisCharacterActor::IsAccItemPos(int32 _Pos) const {
    return false;
}
...
void APolarisCharacterActor::CancelCharacterMaterialAnimation(int32 Type, bool isEnable) {
}
