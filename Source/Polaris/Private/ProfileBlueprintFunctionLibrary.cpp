...
void UProfileBlueprintFunctionLibrary::ShowButtonHelp() {
}
...
void UProfileBlueprintFunctionLibrary::HideButtonHelp() {
}
...
FString UProfileBlueprintFunctionLibrary::GetCharacterIconMTexturePath(int32 fighter_id) {
    return TEXT("");
}
