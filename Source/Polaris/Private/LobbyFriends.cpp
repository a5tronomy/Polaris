...
void ULobbyFriends::LobbyOpenResolvePrivilegeUI(ULobbyFriends::FOnCallbackBool OnFinishOpenResolvePrivilegeUI) {
}

void ULobbyFriends::LobbyClearOpenResolvePrivilegeUI() {
}
