...
void UPolarisColorBlendComponent::PlayEX(UPrimitiveComponent* NewTarget, float NewDelaySecond, float NewEndSecond, FVector4 NewStartColor, FVector4 NewEndColor) {
}
