...
int32 UPolarisUMGIngameStoreBlackPen::AssignRectGrid(UPolarisUMGStoreButton* Button, int32 x1, int32 x2, int32 y1, int32 y2) {
    return 0;
}

int32 UPolarisUMGIngameStoreBlackPen::AssignGrid(UPolarisUMGStoreButton* Button, int32 X, int32 Y) {
    return 0;
}
