...
FSoundPlayerVoiceHandle UPolarisBlueprintLibrary::KeyOnWWiseAudioEvent2(UAkAudioEvent* _srcEvent, int32 NoMultiPlayFrame, AActor* _srcActor) {
    return FSoundPlayerVoiceHandle{};
}

void UPolarisBlueprintLibrary::KeyOnWWiseAudioEvent(UAkAudioEvent* _srcEvent, int32 NoMultiPlayFrame, AActor* _srcActor) {
}

void UPolarisBlueprintLibrary::KeyOffWWiseAudioEvent(FSoundPlayerVoiceHandle Handle, int32 duration_millisecond) {
}
...
bool UPolarisBlueprintLibrary::IsWeakening(int32 player_id) {
    return false;
}
...
bool UPolarisBlueprintLibrary::IsValidSoundPlayerVoiceHandle(FSoundPlayerVoiceHandle Handle) {
    return false;
}

bool UPolarisBlueprintLibrary::IsSwitchedToPracticeDeku() {
    return false;
}
...
bool UPolarisBlueprintLibrary::IsPlayingWWiseAudioEvent(FSoundPlayerVoiceHandle Handle) {
    return false;
}
...
int32 UPolarisBlueprintLibrary::GetTextureFormat(UTexture2D* pTex) {
    return 0;
}
...
TSubclassOf<AActor> UPolarisBlueprintLibrary::GetResultLightBP() {
    return NULL;
}
...
void UPolarisBlueprintLibrary::GetReplayTipsForBattleResult(int32& Punishes, int32& Combos, int32& Crouches, int32& Escapes) {
}
...
int32 UPolarisBlueprintLibrary::GetFighterBodySizeType(int32 player_id) {
    return 0;
}
