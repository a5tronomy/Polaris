...
void UPolarisAutoTestBlueprintLibrary::AutoTest_SetFinishCharCusItemThumbnailCapture() {
}
...
bool UPolarisAutoTestBlueprintLibrary::AutoTest_IsFinishCharCusItemThumbnailCapture() {
    return false;
}
...
EAutoTest UPolarisAutoTestBlueprintLibrary::AutoTest_GetTestType() {
    return EAutoTest::OFF;
}
