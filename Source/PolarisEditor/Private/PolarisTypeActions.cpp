...
FText FCustomizeItemActions::GetAssetDescription(const FAssetData& AssetData) const
{
...
void FCustomizeItemActions::OpenAssetEditor(const TArray<UObject*>& InObjects,
	TSharedPtr<IToolkitHost> EditWithinLevelEditor)
{
	// MakeShared<FCustomizeItemEditorToolkit>()->InitEditor(InObjects);
	return FAssetTypeActions_Base::OpenAssetEditor(InObjects, EditWithinLevelEditor);
}
